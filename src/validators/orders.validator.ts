...
export const ordersValidator = Joi.object({
  name: Joi.string()
    ...
    .messages({
      "string.pattern.base":
        "Name may consist of uppercase and lowercase Latin letters (A-Za-z), uppercase and lowercase Cyrillic letters (А-Яа-я), Cyrillic soft sign (Ёё), and whitespace characters.",
    }),
  surname: Joi.string()
    .regex(/^[A-Za-zА-Яа-яЁё\s]+$/)
    .messages({
      "string.pattern.base":
        "Surname may consist of uppercase and lowercase Latin letters (A-Za-z), uppercase and lowercase Cyrillic letters (А-Яа-я), Cyrillic soft sign (Ёё), and whitespace characters.",
    }),
  email: Joi.string()
    .regex(
